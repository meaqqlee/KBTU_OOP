...
public class TestCases {
    public static void main(String[] args) {
        ...
        Employee emp1 = new Employee("Magzhan", 50000, new Date(), "NI12345");
        Employee emp2 = new Employee("Aktanberdi", 55000, new Date(), "NI54321");
        emp2.setSalary(59000.0f);
        Employee emp3 = new Employee("Tilek", 23000, new Date(), "NI845621");

        Manager mgr1 = new Manager("Rakhman", 70000, new Date(), "NI67890", 5000);
        ...
        Manager mgr2 = new Manager("Aizen", 70000, new Date(), "NI11223", 6000);
        Manager mgr3 = new Manager("Ichigo", 75000, new Date(), "NI44556", 3000);
        ...
        // equals test
        Manager mgr4 = new Manager("Gojo", 70000, new Date(), "NI67890", 5000); // copy
